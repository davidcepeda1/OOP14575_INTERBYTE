...
import ec.espe.edu.FoodAndRollOrderV.controller.TextFielController;
...
public class FrmPlateAdministrator extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(PlateController.createPlate(plate)){
            ...
            JOptionPane.showMessageDialog(null, "No ha podido regitsrate el plato");
        }
        }
    ...
    private void txfPriceKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txfPriceKeyTyped
        ...
        if(TextFielController.esCaracterValido(caracter, txfId)){
            evt.consume();
        }
